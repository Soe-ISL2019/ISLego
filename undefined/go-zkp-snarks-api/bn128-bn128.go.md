...
* 메소드 구성
  ...
  *  G1, G2 operations
  *  preparePairing
  *  PreComupteG1, PreComupteG2
  *  DoubleStep, AddStep
  *  MillerLoop
  *  Pairing

{% code title="bn128/bn128.go" %}
```go
package bn128 //Barreto-Naehrig Curves(BN 타원곡선)에서 페어링 구현, 보안 수준은 128비트
//페어링: 타원곡선 상에서 정의되는 두 점을 유한체 상의 원소로 매핑하는 것

import (
	"errors"   //error 패키지
	"math/big" //임의 정밀도 산술 구현

	"github.com/arnaucube/go-snark/fields" //체 (fields) 구현 패키지
)

// Bn128 is the data structure of the BN128
type Bn128 struct { //Bn128 구조체
	Q             *big.Int //타원 곡선상 점?
	R             *big.Int //타원 곡선상 점?
	Gg1           [2]*big.Int
	Gg2           [2][2]*big.Int //Group element 2? 자료형은 부호 있는 정수
	NonResidueFq2 *big.Int
	NonResidueFq6 [2]*big.Int
	Fq1           fields.Fq   //유한체 1의 기본 연산
	Fq2           fields.Fq2  //유한체 2의 기본 연산
	Fq6           fields.Fq6  //유한체 6의 기본 연산
	Fq12          fields.Fq12 //유한체 12의 기본 연산
	G1            G1
	G2            G2
	LoopCount     *big.Int
	LoopCountNeg  bool
	...
	Twist              [2]*big.Int
	FrobeniusCoeffsC11 *big.Int //프로베니우스 연산?
...
func NewBn128() (Bn128, error) {//BN128 타원곡선 생성 메소드로 Bn128, error형 값 리턴
	var b Bn128 //자료형 Bn128인 변수 b 선언
	...
	b.Q = q //q라는 값 세팅해 곡선의 한 점으로 설정

	r, ok := new(big.Int).SetString("21888242871839275222246405745257275088548364400416034343698204186575808495617", 10)
	if !ok {
		return b, errors.New("err with r")
	}
	b.R = r //r이라는 값 세팅해 곡선의 한 점으로 설정
